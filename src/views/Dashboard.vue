    ...
    <div v-if="currentSection === 'home'">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <div
          ...
          :key="repo.id"
          class="bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl text-white"
        >
          <router-link
            :to="{ name: 'RepositoryDetails', params: { id: repo.name } }"
    ...
    <div v-if="currentSection === 'about'">
      ...
      <div class="bg-dark p-6 rounded-lg shadow-lg">
        <div class="flex flex-col md:flex-row items-center">
          <img
            src="@/assets/vibbi.jpg"
            alt="Profile"
            class="w-32 h-32 rounded-full mb-4 md:mb-0 md:mr-6"
          />
          <div>
            <p class="text-lg mb-2">
              Hello, My name is Simeon Nyakeh Vibbi. I'm a frontend developer
              with a passion for creating elegant and efficient Web Applications.
              Welcome to my Github portfolio where you can explore my projects and
              contributions.
            </p>
            <p class="text-lg">
          ...
          <div class="flex flex-wrap gap-4">
            <div class="flex items-center bg-gray-200 p-2 rounded">
              ...
              >
                <path
                  fill-rule="evenodd"
                  d="M10 3a1 1 0 00-.894.553l-7 14A1 1 0 002 19h16a1 1 0 00.894-1.447l-7-14A1 1 0 0010 3zM5 16h10l-5-10-5 10z"
                  clip-rule="evenodd"
                />
              </svg>
              <span>Anime</span>
            ...
            <div class="flex items-center bg-gray-200 p-2 rounded">
              ...
              >
                <path
                  d="M4 2a2 2 0 000 4h12a2 2 0 100-4H4zM2 6h16a1 1 0 011 1v10a2 2 0 01-2 2H3a2 2 0 01-2-2V7a1 1 0 011-1z"
                />
              </svg>
            ...
            <div class="flex items-center bg-gray-200 p-2 rounded">
              ...
              >
                <path
                  fill-rule="evenodd"
                  d="M3 2a1 1 0 011-1h12a1 1 0 011 1v16a1 1 0 01-1 1H4a1 1 0 01-1-1V2zm2 15h10V3H5v14z"
                  clip-rule="evenodd"
                />
              </svg>
              <span>Reading</span>
            ...
            <div class="flex items-center bg-gray-200 p-2 rounded">
              ...
              >
                <path
                  fill-rule="evenodd"
                  d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-10.707a1 1 0 00-1.414-1.414L9 10.172 7.707 8.879a1 1 0 10-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                  clip-rule="evenodd"
                />
              </svg>
              <span>Cooking</span>
